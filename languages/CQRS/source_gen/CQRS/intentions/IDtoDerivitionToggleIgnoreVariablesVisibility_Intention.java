...
public final class IDtoDerivitionToggleIgnoreVariablesVisibility_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public IDtoDerivitionToggleIgnoreVariablesVisibility_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:ff36ef3b-9652-473a-8811-c1d101cc2db3(CQRS.intentions)", "757976835736398963"));
  }

  @Override
  public String getPresentation() {
    return "IDtoDerivitionToggleIgnoreVariablesVisibility";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return ((SPropertyOperations.getBoolean(node, PROPS.showIgnoredVariables$glFd) ? "Remove" : "Add")) + " 'ignore' declaration";
    }

    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      SPropertyOperations.set(node, PROPS.showIgnoredVariables$glFd, !(SPropertyOperations.getBoolean(node, PROPS.showIgnoredVariables$glFd)));

      if (SPropertyOperations.getBoolean(node, PROPS.showIgnoredVariables$glFd)) {
        SelectionUtil.selectLabelCellAnSetCaret(editorContext, node, "ignoredVariablesStartBraceCellId", -1);
        return;
      }

      IDtoDerivation__BehaviorDescriptor.clearIgnoredVariables_id3NXs7ypg5IO.invoke(node);
    ...
    public IntentionDescriptor getDescriptor() {
      return IDtoDerivitionToggleIgnoreVariablesVisibility_Intention.this;
    }
