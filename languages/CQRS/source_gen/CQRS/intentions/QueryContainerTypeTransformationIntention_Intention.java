...
public final class QueryContainerTypeTransformationIntention_Intention extends AbstractIntentionDescriptor implements IntentionFactory {

  public QueryContainerTypeTransformationIntention_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:ff36ef3b-9652-473a-8811-c1d101cc2db3(CQRS.intentions)", "7215197606711006413"));
  }

  @Override
  public String getPresentation() {
    return "QueryContainerTypeTransformationIntention";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable implements ParameterizedIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Transform to query " + SEnumOperations.getMemberPresentation(myParameter);
    }

    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      SPropertyOperations.setEnum(node, PROPS.type$7YBQ, myParameter);

      if ((boolean) QueryContainer__BehaviorDescriptor.isQueriesBlock_id6gxxZVtebNx.invoke(node)) {
      ...
      if ((SLinkOperations.getTarget(node, LINKS.nameWrapper$X65Q) == null)) {
        SNodeFactoryOperations.setNewChild(node, LINKS.nameWrapper$X65Q, null);
      }
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      return !(SPropertyOperations.getEnum(node, PROPS.type$7YBQ).equals(myParameter));
    }


    @Override
    public IntentionDescriptor getDescriptor() {
      return QueryContainerTypeTransformationIntention_Intention.this;
    }
