...
public final class CommandToggleRequiredRepositoriesIntention_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public CommandToggleRequiredRepositoriesIntention_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:ff36ef3b-9652-473a-8811-c1d101cc2db3(CQRS.intentions)", "5614474895151864078"));
  }

  @Override
  public String getPresentation() {
    return "CommandToggleRequiredRepositoriesIntention";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      return !((boolean) Command__BehaviorDescriptor.isInsideCommandContainer_id1jrq3npy$dZ.invoke(node)) || (boolean) CommandContainer__BehaviorDescriptor.isCommandsBlock_id1LTEHzOe0y.invoke(Command__BehaviorDescriptor.getCommandContainer_id5$Oa659Yq3n.invoke(node));
    }


    @Override
    public IntentionDescriptor getDescriptor() {
      return CommandToggleRequiredRepositoriesIntention_Intention.this;
    }
