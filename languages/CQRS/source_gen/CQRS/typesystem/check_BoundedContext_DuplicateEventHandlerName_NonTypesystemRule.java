...
public class check_BoundedContext_DuplicateEventHandlerName_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public check_BoundedContext_DuplicateEventHandlerName_NonTypesystemRule() {
  }
  public void applyRule(final SNode boundedContext, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    Map<String, List<SNode>> grouping = CollectionUtils.groupBy(BoundedContext__BehaviorDescriptor.eventHandler_id3fVLq_o$tMg.invoke(boundedContext), (SNode container) -> (String) EventContainer__BehaviorDescriptor.getEventContainerName_id5jZDGTdpgfc.invoke(container));
          ...
          public void visit(SNode component) {
            {
              ...
              IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(component, "Another event handler with name '" + key + "' is already defined", "r:536879c6-46f8-4c9c-860d-b388e5bcaaf0(CQRS.typesystem)", "4421886450488529812", null, errorTarget);
            }
          }
        });
      }
