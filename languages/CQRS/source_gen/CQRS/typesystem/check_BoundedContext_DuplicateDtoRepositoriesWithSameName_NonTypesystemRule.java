...
public class check_BoundedContext_DuplicateDtoRepositoriesWithSameName_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public check_BoundedContext_DuplicateDtoRepositoriesWithSameName_NonTypesystemRule() {
  }
  public void applyRule(final SNode boundedContext, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    Map<String, List<SNode>> grouping = CollectionUtils.groupBy(BoundedContext__BehaviorDescriptor.dtoRepositories_id1WhJCpUS1If.invoke(boundedContext), (SNode repository) -> (String) IRepository__BehaviorDescriptor.repositoryName_idmdpAJL$$QT.invoke(repository));
          ...
          public void visit(SNode component) {
            {
              ...
              IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(component, "Another dto repository with name '" + key + "' is already defined", "r:536879c6-46f8-4c9c-860d-b388e5bcaaf0(CQRS.typesystem)", "4421886450482453567", null, errorTarget);
            }
          }
        });
      }
