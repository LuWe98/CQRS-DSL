...
public class GenerationSettings_ActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_COPY(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        LogContext.with(GenerationSettings_ActionMap.class, null, null, null).debug("Copy");
      }
      @Override
  ...
  /*package*/ static AbstractCellAction createAction_CUT(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        LogContext.with(GenerationSettings_ActionMap.class, null, null, null).debug("Cut");
      }
      @Override
      public boolean canExecute(EditorContext editorContext) {
        return this.canExecute_internal(editorContext, node);
  ...
  /*package*/ static AbstractCellAction createAction_PASTE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        LogContext.with(GenerationSettings_ActionMap.class, null, null, null).debug("Paste");
      }
      @Override
      public boolean canExecute(EditorContext editorContext) {
        return this.canExecute_internal(editorContext, node);
