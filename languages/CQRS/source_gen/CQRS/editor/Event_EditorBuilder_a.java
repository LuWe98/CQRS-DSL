...
/*package*/ class Event_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_ymj9mh_a5a()) {
      editorCell.addEditorCell(createCollection_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_ymj9mh_a0a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.shouldShowKeyword$F8mB);
  }
  private boolean nodeCondition_ymj9mh_a5a() {
  ...
  private EditorCell createConstant_1() {
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, _StyleParameter_QueryFunction_ymj9mh_a0c0());
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private boolean _StyleParameter_QueryFunction_ymj9mh_a0c0() {
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.getStyle().putAll(style);
    EventRequiredDtoRepositoriesDeletionActionMap.setCellActions(editorCell, myNode, getEditorContext());
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_ymj9mh_a5a");
    Style style = new StyleImpl();
