...
public class OptionalConstructorActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, node, "parametersBody")) {
          return;
        }
        ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.parameters$t6h4)).clear();
        SelectionUtil.selectCell(editorContext, node, "bodyStart");
      }
      @Override
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.parameters$t6h4)).isNotEmpty();
      }
