...
public class DtoRepositoryReferenceDeletionActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, SNodeOperations.cast(editorContext.getSelectedNode(), CONCEPTS.DtoRepositoryReference$up))) {
          return;
        }
        SNodeOperations.deleteNode(SNodeOperations.cast(editorContext.getSelectedNode(), CONCEPTS.DtoRepositoryReference$up));
      }
      @Override
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return editorContext.getSelectedNode().isInstanceOfConcept(CONCEPTS.DtoRepositoryReference$up);
      }
