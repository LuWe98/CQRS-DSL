...
public class GenericDataTypeDeletion_ActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        ...
        if (!(SNodeOperations.getConcept(selectedNode).isAbstract())) {
          if (DeletionApproverUtil.approve(editorContext, selectedNode)) {
            return;
          }
          SNodeOperations.replaceWithAnother(selectedNode, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getInterfaceConcept(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x4cfae7e929829c9dL, "CQRS.structure.IDataType"))));
          return;
        }
        SNodeOperations.replaceWithAnother(selectedNode, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getInterfaceConcept(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x4cfae7e929829c9dL, "CQRS.structure.IDataType"))));
      }
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(SNodeOperations.getConcept(node)), CONCEPTS.IDataType$Sx);
      }
