...
public class Dto_DerivedFromBlockDeletion_ActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, node, "derivedFromBlockCellId")) {
          return;
        }
        Dto__BehaviorDescriptor.resetDerivedFromBlock_id3NXs7ypjFaC.invoke(node);
        SelectionUtil.selectCell(editorContext, node, "constructorRightBraceCellId");
      }
      @Override
