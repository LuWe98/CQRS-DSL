...
import CQRS.behavior.DescriptionLine__BehaviorDescriptor;
...
public class DescriptionLine_ActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNode nodeContainingDescription = SNodeOperations.getParent(DescriptionLine__BehaviorDescriptor.getDescriptionParent_id23r34DNYVIF.invoke(node));
        if (DeletionApproverUtil.approve(editorContext, nodeContainingDescription)) {
          return;
        }
        SNodeOperations.deleteNode(nodeContainingDescription);
      }
