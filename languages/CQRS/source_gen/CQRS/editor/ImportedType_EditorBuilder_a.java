...
/*package*/ class ImportedType_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ImportedType_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_6nkgmv_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createRefCell_0());
    if (nodeCondition_6nkgmv_a1a()) {
      editorCell.addEditorCell(createCollection_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_6nkgmv_a1a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.actualTypes$o6Gi)).isNotEmpty();
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.importStatement$D_66;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.importStatement$D_66);
    ...
    provider.setNoTargetText("<no importStatement>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.importStatement$D_66);
    }
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.ImportedType$3u, "CQRS.editor.ImportStatementReferenceCreateTypeArgumentsTransformationMenu"));
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_6nkgmv_b0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_6nkgmv_a1a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new actualTypesListHandler_6nkgmv_b1a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("typeVariableList");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class actualTypesListHandler_6nkgmv_b1a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public actualTypesListHandler_6nkgmv_b1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actualTypesListHandler_6nkgmv_b1a.this.getNode(), LINKS.actualTypes$o6Gi));
      try {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ">");
    editorCell.setCellId("Constant_6nkgmv_c1a");
    Style style = new StyleImpl();
