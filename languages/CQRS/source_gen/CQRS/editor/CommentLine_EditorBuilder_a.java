...
/*package*/ class CommentLine_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.text$DbM6;
      ...
      Style style = new StyleImpl();
      style.set(StyleAttributes.TEXT_COLOR, getStyleRegistry().getSimpleColor(MPSColors.gray));
      if (_StyleParameter_QueryFunction_dzsxo_a1b0()) {
  ...
  private boolean _StyleParameter_QueryFunction_dzsxo_a1b0() {
    return SPropertyOperations.getString(getNode(), PROPS.text$DbM6) != null && SPropertyOperations.getString(getNode(), PROPS.text$DbM6).startsWith("TODO");
  }

  private static final class PROPS {
    /*package*/ static final SProperty text$DbM6 = MetaAdapterFactory.getProperty(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x62cb964345d71a2L, 0x62cb964345d71a5L, "text");
  }
