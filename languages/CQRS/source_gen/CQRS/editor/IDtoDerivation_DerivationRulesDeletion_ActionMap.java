...
public class IDtoDerivation_DerivationRulesDeletion_ActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, node, "derivationRulesBlockId")) {
          return;
        }
        IDtoDerivation__BehaviorDescriptor.resetUsedDerivationRules_id5QsWOhW8B1z.invoke(node);
...

        {
          ...
          if (SNodeOperations.isInstanceOf(flatteningRule, CONCEPTS.DtoFlatteningRule$GR)) {
            SelectionUtil.selectCell(editorContext, flatteningRule, SelectionManager.LAST_CELL);
          }
        }
      }
      @Override
