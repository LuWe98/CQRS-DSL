...
/*package*/ class Query_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_3jay6a_a8a()) {
      editorCell.addEditorCell(createCollection_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_3jay6a_a0a() {
    return !((boolean) Query__BehaviorDescriptor.isInsideQueryContainer_id2Bsub$Lr4Li.invoke(myNode)) || SPropertyOperations.getBoolean(myNode, PROPS.shouldShowKeyword$F8mB);
  }
  private boolean nodeCondition_3jay6a_a8a() {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("queryKeywordCellId");
  ...
  private EditorCell createConstant_1() {
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, _StyleParameter_QueryFunction_3jay6a_a0c0());
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private boolean _StyleParameter_QueryFunction_3jay6a_a0c0() {
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_3jay6a_e0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new returnTypeSingleRoleHandler_3jay6a_g0(myNode, LINKS.returnType$WTqX, getEditorContext());
    return provider.createCell();
  }
  private static class returnTypeSingleRoleHandler_3jay6a_g0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public returnTypeSingleRoleHandler_3jay6a_g0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.returnType$WTqX, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.returnType$WTqX, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.returnType$WTqX);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.returnType$WTqX));
      try {
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.getStyle().putAll(style);
    QueryRequiredDtoRepositoriesDeletionActionMap.setCellActions(editorCell, myNode, getEditorContext());
