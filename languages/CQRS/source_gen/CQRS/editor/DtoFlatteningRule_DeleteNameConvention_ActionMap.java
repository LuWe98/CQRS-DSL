...
public class DtoFlatteningRule_DeleteNameConvention_ActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, node, "nameConventionBlockId")) {
          return;
        }
        SPropertyOperations.setEnum(node, PROPS.nameConvention$LtCG, 0x3cfd70789afeffaaL, "None");

        SelectionUtil.selectLabelCellAnSetCaret(editorContext, node, "usageCellId", -1);
      }
      @Override
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return !(SEnumOperations.isMember(SPropertyOperations.getEnum(node, PROPS.nameConvention$LtCG), 0x3cfd70789afeffaaL));
      }
