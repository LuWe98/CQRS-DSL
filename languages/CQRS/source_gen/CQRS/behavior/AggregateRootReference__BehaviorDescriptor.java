...
public final class AggregateRootReference__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x4f0a0db9ac16f8f2L, "CQRS.structure.AggregateRootReference");
  ...
  /*package*/ static boolean hasSameDatatype_id3DbZR$NHBwn(@NotNull SNode __thisNode__, SNode otherDataType) {
    {
      final SNode aggregateReference = otherDataType;
      if (SNodeOperations.isInstanceOf(aggregateReference, CONCEPTS.AggregateRootReference$5T)) {
        return SLinkOperations.getTarget(__thisNode__, LINKS.aggregate$D_P$) == SLinkOperations.getTarget(aggregateReference, LINKS.aggregate$D_P$);
      }
    }
    return false;
  }
  /*package*/ static SNode getDtoDerivable_id4LpUh3T0tIy(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.aggregate$D_P$);
  }

  /*package*/ AggregateRootReference__BehaviorDescriptor() {
  }
