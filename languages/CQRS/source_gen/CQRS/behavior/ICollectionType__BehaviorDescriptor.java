...
public final class ICollectionType__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x4cfae7e929829cbdL, "CQRS.structure.ICollectionType");
  ...
  /*package*/ static boolean hasSameDatatype_id3DbZR$NHBwn(@NotNull SNode __thisNode__, SNode otherDataType) {
    {
      ...
      if (SNodeOperations.isInstanceOf(javaType, CONCEPTS.JavaDataType$MU)) {
        return JavaTypeCheckUtils.doesJavaTypeMatchCollectionType(SLinkOperations.getTarget(javaType, LINKS.actualType$WqWC), __thisNode__);
      }
    }

    {
      ...
      if (SNodeOperations.isInstanceOf(collectionType, CONCEPTS.ICollectionType$rd)) {
        return Objects.equals(SNodeOperations.getConcept(__thisNode__), SNodeOperations.getConcept(collectionType)) && (boolean) IDataType__BehaviorDescriptor.hasSameDatatype_id3DbZR$NHBwn.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.elementType$AnT5), SLinkOperations.getTarget(collectionType, LINKS.elementType$AnT5));
      }
    }
  ...
  /*package*/ ICollectionType__BehaviorDescriptor() {
  }
