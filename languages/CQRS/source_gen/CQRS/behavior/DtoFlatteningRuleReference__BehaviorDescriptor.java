...
public final class DtoFlatteningRuleReference__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x78c544923a1c15a0L, "CQRS.structure.DtoFlatteningRuleReference");
  ...
  /*package*/ static SNode getReferencedRule_id5YqiGT0mxXR(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.rule$j7q4);
  }

  /*package*/ DtoFlatteningRuleReference__BehaviorDescriptor() {
  }
