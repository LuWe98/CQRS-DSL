...
public final class DtoRepositoryReference__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x642187fedbd24164L, "CQRS.structure.DtoRepositoryReference");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getRepository_id5jZDGTil89u);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static SNode getRepository_id5jZDGTil89u(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.dtoRepository$QKV9);
  }

  /*package*/ DtoRepositoryReference__BehaviorDescriptor() {
  }
