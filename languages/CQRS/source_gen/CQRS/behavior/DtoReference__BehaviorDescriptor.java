...
public final class DtoReference__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x4f0a0db9ac16f906L, "CQRS.structure.DtoReference");
  ...
  /*package*/ static boolean hasSameDatatype_id3DbZR$NHBwn(@NotNull SNode __thisNode__, SNode otherDataType) {
    return Objects.equals(SNodeOperations.getConcept(__thisNode__), SNodeOperations.getConcept(otherDataType)) && SLinkOperations.getTarget(__thisNode__, LINKS.dto$DOQ$) == SLinkOperations.getTarget(SNodeOperations.cast(otherDataType, CONCEPTS.DtoReference$zV), LINKS.dto$DOQ$);
  }

  /*package*/ DtoReference__BehaviorDescriptor() {
  }
