...
public final class ValueObjectReference__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfe04f903cef2451dL, 0x9401426cad0a8857L, 0x4f0a0db9ac16f8faL, "CQRS.structure.ValueObjectReference");
  ...
  /*package*/ static boolean hasSameDatatype_id3DbZR$NHBwn(@NotNull SNode __thisNode__, SNode otherDataType) {
    return Objects.equals(SNodeOperations.getConcept(__thisNode__), SNodeOperations.getConcept(otherDataType)) && SLinkOperations.getTarget(__thisNode__, LINKS.valueObject$DGR4) == SLinkOperations.getTarget(SNodeOperations.cast(otherDataType, CONCEPTS.ValueObjectReference$jW), LINKS.valueObject$DGR4);
  }
  /*package*/ static SNode getDtoDerivable_id4LpUh3T0tIy(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.valueObject$DGR4);
  }

  /*package*/ ValueObjectReference__BehaviorDescriptor() {
  }
