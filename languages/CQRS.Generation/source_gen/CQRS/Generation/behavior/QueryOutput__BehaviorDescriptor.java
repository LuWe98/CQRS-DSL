...
public final class QueryOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0xa1fc5d1dac8a772L, "CQRS.Generation.structure.QueryOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveQuery(SLinkOperations.getTarget(__thisNode__, LINKS.query$XyyR));
  }

  /*package*/ QueryOutput__BehaviorDescriptor() {
  }
