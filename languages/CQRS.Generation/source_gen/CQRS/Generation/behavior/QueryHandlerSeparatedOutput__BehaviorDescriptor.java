...
public final class QueryHandlerSeparatedOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0x1a77dd18db1da0fbL, "CQRS.Generation.structure.QueryHandlerSeparatedOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveQueryHandlerSpecific(SLinkOperations.getTarget(__thisNode__, LINKS.query$ysaA));
  }

  /*package*/ QueryHandlerSeparatedOutput__BehaviorDescriptor() {
  }
