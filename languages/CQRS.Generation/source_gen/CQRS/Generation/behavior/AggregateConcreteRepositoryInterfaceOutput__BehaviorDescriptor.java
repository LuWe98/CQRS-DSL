...
public final class AggregateConcreteRepositoryInterfaceOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0x1a77dd18de31fc1eL, "CQRS.Generation.structure.AggregateConcreteRepositoryInterfaceOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveAggregateConcreteRepositoryInterface(SLinkOperations.getTarget(__thisNode__, LINKS.repository$6gjW));
  }

  /*package*/ AggregateConcreteRepositoryInterfaceOutput__BehaviorDescriptor() {
  }
