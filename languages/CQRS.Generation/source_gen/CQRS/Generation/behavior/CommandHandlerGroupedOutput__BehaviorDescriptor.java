...
public final class CommandHandlerGroupedOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0x33fbc5a9591d98baL, "CQRS.Generation.structure.CommandHandlerGroupedOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveCommandHandlerGrouped(SLinkOperations.getTarget(__thisNode__, LINKS.container$uWWL));
  }

  /*package*/ CommandHandlerGroupedOutput__BehaviorDescriptor() {
  }
