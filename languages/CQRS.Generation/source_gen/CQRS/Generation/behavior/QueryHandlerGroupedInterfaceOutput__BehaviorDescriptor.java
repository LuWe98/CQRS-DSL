...
public final class QueryHandlerGroupedInterfaceOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0x33fbc5a96964f0a4L, "CQRS.Generation.structure.QueryHandlerGroupedInterfaceOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveQueryHandlerGroupedInterface(SLinkOperations.getTarget(__thisNode__, LINKS.container$PU53));
  }

  /*package*/ QueryHandlerGroupedInterfaceOutput__BehaviorDescriptor() {
  }
