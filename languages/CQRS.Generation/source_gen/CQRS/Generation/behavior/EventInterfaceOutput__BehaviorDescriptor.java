...
public final class EventInterfaceOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0xe220c2db6f921b8L, "CQRS.Generation.structure.EventInterfaceOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveEventInterface(SPropertyOperations.getEnum(__thisNode__, PROPS.applicationSide$_6r5));
  }

  /*package*/ EventInterfaceOutput__BehaviorDescriptor() {
  }
