...
public final class CommandHandlerInterfaceOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0x42e485aea780bf2fL, "CQRS.Generation.structure.CommandHandlerInterfaceOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveCommandHandlerInterface();
  }

  /*package*/ CommandHandlerInterfaceOutput__BehaviorDescriptor() {
  }
