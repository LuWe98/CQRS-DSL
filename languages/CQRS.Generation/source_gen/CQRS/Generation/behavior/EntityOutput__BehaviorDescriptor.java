...
public final class EntityOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0x42e485aea749033fL, "CQRS.Generation.structure.EntityOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveEntity(SLinkOperations.getTarget(__thisNode__, LINKS.entity$OPtA));
  }

  /*package*/ EntityOutput__BehaviorDescriptor() {
  }
