...
public final class CommandHandlerSeparatedOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x273bc31819694c83L, 0x8484525ea753e78bL, 0x2cd995488ae1ebf3L, "CQRS.Generation.structure.CommandHandlerSeparatedOutput");
  ...
  /*package*/ static DependencyImport getImport_idSy32QQYkNm(@NotNull SNode __thisNode__, GenerationTarget target) {
    return ComponentOutput__BehaviorDescriptor.resolver_id4b$xqUBa0Kt.invoke(__thisNode__, target).resolveCommandHandlerSpecific(SLinkOperations.getTarget(__thisNode__, LINKS.command$Ua6h));
  }

  /*package*/ CommandHandlerSeparatedOutput__BehaviorDescriptor() {
  }
