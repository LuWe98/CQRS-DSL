...
public final class EventHandlerInterfaceKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0xe220c2db6f9cdccL, "CQRS.Kotlin.structure.EventHandlerInterfaceKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    return SetSequence.fromSetAndArray(new HashSet<DependencyImport>(), KotlinFileOutput__BehaviorDescriptor.resolver_id4b$xqUBa5Fw.invoke(__thisNode__).resolveEventInterface(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x273bc31819694c83L, 0x8484525ea753e78bL, 0x2cd9954889e49a89L, "CQRS.Generation.structure.ApplicationSide"), 0x2cd9954889e49a8bL, "QUERY_SIDE")));
  }

  /*package*/ EventHandlerInterfaceKotlinOutput__BehaviorDescriptor() {
  }
