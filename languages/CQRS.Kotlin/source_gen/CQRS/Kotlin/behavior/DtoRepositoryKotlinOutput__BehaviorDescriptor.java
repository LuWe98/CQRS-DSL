...
public final class DtoRepositoryKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x33fbc5a9717ffdfdL, "CQRS.Kotlin.structure.DtoRepositoryKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    Set<DependencyImport> imports = SetSequence.fromSet(new LinkedHashSet<DependencyImport>());
    SetSequence.fromSet(imports).addElement(resolver.resolveDtoRepositoryInterface(SLinkOperations.getTarget(__thisNode__, LINKS.repository$3egk)));
    SetSequence.fromSet(imports).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.methods$3eIm)).translate(new ITranslator2<SNode, DependencyImport>() {
  ...
  /*package*/ DtoRepositoryKotlinOutput__BehaviorDescriptor() {
  }
