...
public final class QueryHandlerGroupedInterfaceKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x33fbc5a96964f0b5L, "CQRS.Kotlin.structure.QueryHandlerGroupedInterfaceKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addElement(resolver.resolveQueryHandlerGroupedInterface(SLinkOperations.getTarget(__thisNode__, LINKS.container$PU53)));
    SetSequence.fromSet(imports).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.methods$HjIh)).translate(new ITranslator2<SNode, DependencyImport>() {
  ...
  /*package*/ QueryHandlerGroupedInterfaceKotlinOutput__BehaviorDescriptor() {
  }
