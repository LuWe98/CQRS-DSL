...
public final class EventWrapperInterfaceKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x1a77dd18db67e490L, "CQRS.Kotlin.structure.EventWrapperInterfaceKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addElement(resolver.resolveEventInterface(SPropertyOperations.getEnum(__thisNode__, PROPS.appicationSide$PR1K)));
    SetSequence.fromSet(imports).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.wrappedEvents$17E6)).translate(new ITranslator2<SNode, DependencyImport>() {
  ...
  /*package*/ EventWrapperInterfaceKotlinOutput__BehaviorDescriptor() {
  }
