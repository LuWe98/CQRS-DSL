...
public final class AggregateRepositoryKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x1a77dd18de33a1e3L, "CQRS.Kotlin.structure.AggregateRepositoryKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addElement(resolver.resolveAggregateConcreteRepositoryInterface(SLinkOperations.getTarget(__thisNode__, LINKS.repository$o2pF)));
    SetSequence.fromSet(imports).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.methods$TSUr)).translate(new ITranslator2<SNode, DependencyImport>() {
  ...
  /*package*/ AggregateRepositoryKotlinOutput__BehaviorDescriptor() {
  }
