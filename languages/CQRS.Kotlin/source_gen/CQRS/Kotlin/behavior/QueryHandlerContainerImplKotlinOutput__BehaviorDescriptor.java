...
public final class QueryHandlerContainerImplKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x7849637c4937a21cL, "CQRS.Kotlin.structure.QueryHandlerContainerImplKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addElement(DependencyUtils.KOTLIN_CLASS_IMPORT);
    return imports;
  }

  /*package*/ QueryHandlerContainerImplKotlinOutput__BehaviorDescriptor() {
  }
