...
public final class QueryProcessorImplKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x7849637c4937a216L, "CQRS.Kotlin.structure.QueryProcessorImplKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addElement(resolver.resolveQueryProcessor());
    SetSequence.fromSet(imports).addElement(resolver.resolveQueryHandlerContainer());
    return imports;
  }

  /*package*/ QueryProcessorImplKotlinOutput__BehaviorDescriptor() {
  }
