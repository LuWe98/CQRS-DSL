...
public final class EventHandlerGroupedInterfaceKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x33fbc5a96653a00eL, "CQRS.Kotlin.structure.EventHandlerGroupedInterfaceKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.methods$JWe)).translate(new ITranslator2<SNode, DependencyImport>() {
  ...
  /*package*/ EventHandlerGroupedInterfaceKotlinOutput__BehaviorDescriptor() {
  }
