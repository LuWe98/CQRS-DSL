...
public final class QueryHandlerInterfaceKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0xe220c2db7020f56L, "CQRS.Kotlin.structure.QueryHandlerInterfaceKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    return SetSequence.fromSetAndArray(new HashSet<DependencyImport>(), KotlinFileOutput__BehaviorDescriptor.resolver_id4b$xqUBa5Fw.invoke(__thisNode__).resolveQueryInterface());
  }

  /*package*/ QueryHandlerInterfaceKotlinOutput__BehaviorDescriptor() {
  }
