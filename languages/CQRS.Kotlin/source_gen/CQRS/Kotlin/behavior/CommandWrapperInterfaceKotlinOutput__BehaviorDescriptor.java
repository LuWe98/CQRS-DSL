...
public final class CommandWrapperInterfaceKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x7849637c48be76e7L, "CQRS.Kotlin.structure.CommandWrapperInterfaceKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.wrappedCommands$jiEM)).translate(new ITranslator2<SNode, DependencyImport>() {
  ...
  /*package*/ CommandWrapperInterfaceKotlinOutput__BehaviorDescriptor() {
  }
