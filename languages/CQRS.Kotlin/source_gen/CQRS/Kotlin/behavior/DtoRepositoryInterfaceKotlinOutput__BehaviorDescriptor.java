...
public final class DtoRepositoryInterfaceKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x33fbc5a9717ffe00L, "CQRS.Kotlin.structure.DtoRepositoryInterfaceKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.methods$5H7m)).translate(new ITranslator2<SNode, DependencyImport>() {
  ...
  /*package*/ DtoRepositoryInterfaceKotlinOutput__BehaviorDescriptor() {
  }
