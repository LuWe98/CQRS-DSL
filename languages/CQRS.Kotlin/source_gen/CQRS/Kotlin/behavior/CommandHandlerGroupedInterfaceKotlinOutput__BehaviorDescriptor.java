...
public final class CommandHandlerGroupedInterfaceKotlinOutput__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x21c0c49f06c045cbL, 0x990e6280d48112f6L, 0x33fbc5a959de520fL, "CQRS.Kotlin.structure.CommandHandlerGroupedInterfaceKotlinOutput");
  ...
  /*package*/ static Set<DependencyImport> getImports_id4yUYSn0sW9K(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(imports).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.methods$s3XL)).translate(new ITranslator2<SNode, DependencyImport>() {
  ...
  /*package*/ CommandHandlerGroupedInterfaceKotlinOutput__BehaviorDescriptor() {
  }
